	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(date!=null && s!=null){
			...
			if(password!=null && !password.isBlank() && !password.isEmpty()) {
				...
				//Comprobar si es mayor de 18 años
				
				//Con la siguiente funcion compruebo el numero de años entre una fecha y otra. Si es mayor de edad, pasa el if
				...
				else { //Si es menor, redirijo a la página de error
					response.sendRedirect("error.jsp?redirect=registration&msg=Debe ser mayor a 18 años");
				}
